...
var _RTCCertificate = _interopRequireDefault(require("./RTCCertificate"));
...
class RTCPeerConnection extends _eventTargetShim.EventTarget {
  static generateCertificate(keygenAlgorithm) {
    ...
    return WebRTCModule.generateCertificate(options).then(info => new _RTCCertificate.default(info));
  }
  ...
  get onconnectionstatechange() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'connectionstatechange');
  }
  set onconnectionstatechange(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'connectionstatechange', value);
  }
  get onicecandidate() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'icecandidate');
  }
  set onicecandidate(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'icecandidate', value);
  }
  get onicecandidateerror() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'icecandidateerror');
  }
  set onicecandidateerror(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'icecandidateerror', value);
  }
  get oniceconnectionstatechange() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'iceconnectionstatechange');
  }
  set oniceconnectionstatechange(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'iceconnectionstatechange', value);
  }
  get onicegatheringstatechange() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'icegatheringstatechange');
  }
  set onicegatheringstatechange(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'icegatheringstatechange', value);
  }
  get onnegotiationneeded() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'negotiationneeded');
  }
  set onnegotiationneeded(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'negotiationneeded', value);
  }
  get onsignalingstatechange() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'signalingstatechange');
  }
  set onsignalingstatechange(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'signalingstatechange', value);
  }
  get ondatachannel() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'datachannel');
  }
  set ondatachannel(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'datachannel', value);
  }
  get ontrack() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'track');
  }
  set ontrack(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'track', value);
  }
  get onerror() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'error');
  }
  set onerror(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'error', value);
  }
