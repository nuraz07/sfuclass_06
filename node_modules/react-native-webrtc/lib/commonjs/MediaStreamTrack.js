...
class MediaStreamTrack extends _eventTargetShim.EventTarget {
  constructor(info) {
    super();
  ...
  get onended() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'ended');
  }
  set onended(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'ended', value);
  }
  get onmute() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'mute');
  }
  set onmute(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'mute', value);
  }
  get onunmute() {
    return (0, _eventTargetShim.getEventAttributeValue)(this, 'unmute');
  }
  set onunmute(value) {
    (0, _eventTargetShim.setEventAttributeValue)(this, 'unmute', value);
  }
  get enabled() {
  ...
  async applyConstraints(constraints) {
    ...
    if (constraints && !(constraints !== null && constraints !== void 0 && constraints.facingMode) && (_this$_settings = this._settings) !== null && _this$_settings !== void 0 && _this$_settings.facingMode) {
