...
declare const DisassociateCertificateCommand_base: {
    new (input: DisassociateCertificateCommandInput): import("@smithy/core/client").CommandImpl<DisassociateCertificateCommandInput, DisassociateCertificateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisassociateCertificateCommandInput): import("@smithy/core/client").CommandImpl<DisassociateCertificateCommandInput, DisassociateCertificateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
