...
declare const DeleteQueueCommand_base: {
    new (input: DeleteQueueCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueueCommandInput, DeleteQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteQueueCommandInput): import("@smithy/core/client").CommandImpl<DeleteQueueCommandInput, DeleteQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
