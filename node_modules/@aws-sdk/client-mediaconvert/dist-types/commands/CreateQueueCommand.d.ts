...
declare const CreateQueueCommand_base: {
    new (input: CreateQueueCommandInput): import("@smithy/core/client").CommandImpl<CreateQueueCommandInput, CreateQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateQueueCommandInput): import("@smithy/core/client").CommandImpl<CreateQueueCommandInput, CreateQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
