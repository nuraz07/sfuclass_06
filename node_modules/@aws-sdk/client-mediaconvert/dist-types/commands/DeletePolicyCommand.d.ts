...
declare const DeletePolicyCommand_base: {
    new (input: DeletePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyCommandInput, DeletePolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeletePolicyCommandInput]): import("@smithy/core/client").CommandImpl<DeletePolicyCommandInput, DeletePolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
