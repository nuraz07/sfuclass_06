...
declare const DeletePresetCommand_base: {
    new (input: DeletePresetCommandInput): import("@smithy/core/client").CommandImpl<DeletePresetCommandInput, DeletePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePresetCommandInput): import("@smithy/core/client").CommandImpl<DeletePresetCommandInput, DeletePresetCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
