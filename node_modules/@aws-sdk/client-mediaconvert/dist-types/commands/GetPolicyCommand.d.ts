...
declare const GetPolicyCommand_base: {
    new (input: GetPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyCommandInput, GetPolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetPolicyCommandInput]): import("@smithy/core/client").CommandImpl<GetPolicyCommandInput, GetPolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
