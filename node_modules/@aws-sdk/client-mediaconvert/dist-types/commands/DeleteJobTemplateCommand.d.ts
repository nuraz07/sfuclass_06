...
declare const DeleteJobTemplateCommand_base: {
    new (input: DeleteJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobTemplateCommandInput, DeleteJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteJobTemplateCommandInput): import("@smithy/core/client").CommandImpl<DeleteJobTemplateCommandInput, DeleteJobTemplateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
