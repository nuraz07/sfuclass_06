...
declare const GetQueueCommand_base: {
    new (input: GetQueueCommandInput): import("@smithy/core/client").CommandImpl<GetQueueCommandInput, GetQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetQueueCommandInput): import("@smithy/core/client").CommandImpl<GetQueueCommandInput, GetQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
