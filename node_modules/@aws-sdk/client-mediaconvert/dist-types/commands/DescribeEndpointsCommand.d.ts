...
declare const DescribeEndpointsCommand_base: {
    new (input: DescribeEndpointsCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointsCommandInput, DescribeEndpointsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEndpointsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEndpointsCommandInput, DescribeEndpointsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
