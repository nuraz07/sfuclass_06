...
declare const ListQueuesCommand_base: {
    new (input: ListQueuesCommandInput): import("@smithy/core/client").CommandImpl<ListQueuesCommandInput, ListQueuesCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListQueuesCommandInput]): import("@smithy/core/client").CommandImpl<ListQueuesCommandInput, ListQueuesCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
