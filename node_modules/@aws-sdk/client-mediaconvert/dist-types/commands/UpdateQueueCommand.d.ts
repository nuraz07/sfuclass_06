...
declare const UpdateQueueCommand_base: {
    new (input: UpdateQueueCommandInput): import("@smithy/core/client").CommandImpl<UpdateQueueCommandInput, UpdateQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateQueueCommandInput): import("@smithy/core/client").CommandImpl<UpdateQueueCommandInput, UpdateQueueCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
