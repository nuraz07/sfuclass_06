...
declare const AssociateCertificateCommand_base: {
    new (input: AssociateCertificateCommandInput): import("@smithy/core/client").CommandImpl<AssociateCertificateCommandInput, AssociateCertificateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateCertificateCommandInput): import("@smithy/core/client").CommandImpl<AssociateCertificateCommandInput, AssociateCertificateCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
