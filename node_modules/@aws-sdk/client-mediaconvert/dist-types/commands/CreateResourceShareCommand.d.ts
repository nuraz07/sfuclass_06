...
declare const CreateResourceShareCommand_base: {
    new (input: CreateResourceShareCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceShareCommandInput, CreateResourceShareCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResourceShareCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceShareCommandInput, CreateResourceShareCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
