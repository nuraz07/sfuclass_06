...
declare const ListVersionsCommand_base: {
    new (input: ListVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListVersionsCommandInput, ListVersionsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVersionsCommandInput]): import("@smithy/core/client").CommandImpl<ListVersionsCommandInput, ListVersionsCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
