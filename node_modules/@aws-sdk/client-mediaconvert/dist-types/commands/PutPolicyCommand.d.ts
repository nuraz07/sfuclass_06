...
declare const PutPolicyCommand_base: {
    new (input: PutPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutPolicyCommandInput, PutPolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutPolicyCommandInput, PutPolicyCommandOutput, import("..").MediaConvertClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
