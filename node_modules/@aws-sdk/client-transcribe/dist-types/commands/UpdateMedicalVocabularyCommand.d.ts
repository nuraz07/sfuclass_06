...
declare const UpdateMedicalVocabularyCommand_base: {
    new (input: UpdateMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<UpdateMedicalVocabularyCommandInput, UpdateMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<UpdateMedicalVocabularyCommandInput, UpdateMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
