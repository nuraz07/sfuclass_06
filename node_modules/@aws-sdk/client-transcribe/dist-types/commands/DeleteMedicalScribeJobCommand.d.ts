...
declare const DeleteMedicalScribeJobCommand_base: {
    new (input: DeleteMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteMedicalScribeJobCommandInput, DeleteMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteMedicalScribeJobCommandInput, DeleteMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
