...
declare const ListLanguageModelsCommand_base: {
    new (input: ListLanguageModelsCommandInput): import("@smithy/core/client").CommandImpl<ListLanguageModelsCommandInput, ListLanguageModelsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListLanguageModelsCommandInput]): import("@smithy/core/client").CommandImpl<ListLanguageModelsCommandInput, ListLanguageModelsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
