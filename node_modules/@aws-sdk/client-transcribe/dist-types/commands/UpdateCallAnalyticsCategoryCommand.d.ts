...
declare const UpdateCallAnalyticsCategoryCommand_base: {
    new (input: UpdateCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateCallAnalyticsCategoryCommandInput, UpdateCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<UpdateCallAnalyticsCategoryCommandInput, UpdateCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
