...
declare const ListVocabularyFiltersCommand_base: {
    new (input: ListVocabularyFiltersCommandInput): import("@smithy/core/client").CommandImpl<ListVocabularyFiltersCommandInput, ListVocabularyFiltersCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVocabularyFiltersCommandInput]): import("@smithy/core/client").CommandImpl<ListVocabularyFiltersCommandInput, ListVocabularyFiltersCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
