...
declare const DeleteTranscriptionJobCommand_base: {
    new (input: DeleteTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteTranscriptionJobCommandInput, DeleteTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteTranscriptionJobCommandInput, DeleteTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
