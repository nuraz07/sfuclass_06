...
declare const ListCallAnalyticsJobsCommand_base: {
    new (input: ListCallAnalyticsJobsCommandInput): import("@smithy/core/client").CommandImpl<ListCallAnalyticsJobsCommandInput, ListCallAnalyticsJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCallAnalyticsJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListCallAnalyticsJobsCommandInput, ListCallAnalyticsJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
