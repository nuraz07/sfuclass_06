...
declare const DeleteMedicalVocabularyCommand_base: {
    new (input: DeleteMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<DeleteMedicalVocabularyCommandInput, DeleteMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<DeleteMedicalVocabularyCommandInput, DeleteMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
