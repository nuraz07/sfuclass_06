...
declare const GetMedicalTranscriptionJobCommand_base: {
    new (input: GetMedicalTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalTranscriptionJobCommandInput, GetMedicalTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMedicalTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalTranscriptionJobCommandInput, GetMedicalTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
