...
declare const StartMedicalTranscriptionJobCommand_base: {
    new (input: StartMedicalTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<StartMedicalTranscriptionJobCommandInput, StartMedicalTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMedicalTranscriptionJobCommandInput): import("@smithy/core/client").CommandImpl<StartMedicalTranscriptionJobCommandInput, StartMedicalTranscriptionJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
