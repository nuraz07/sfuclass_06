...
declare const GetCallAnalyticsCategoryCommand_base: {
    new (input: GetCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<GetCallAnalyticsCategoryCommandInput, GetCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<GetCallAnalyticsCategoryCommandInput, GetCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
