...
declare const ListMedicalScribeJobsCommand_base: {
    new (input: ListMedicalScribeJobsCommandInput): import("@smithy/core/client").CommandImpl<ListMedicalScribeJobsCommandInput, ListMedicalScribeJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMedicalScribeJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListMedicalScribeJobsCommandInput, ListMedicalScribeJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
