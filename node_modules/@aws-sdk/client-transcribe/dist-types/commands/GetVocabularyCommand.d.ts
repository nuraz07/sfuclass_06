...
declare const GetVocabularyCommand_base: {
    new (input: GetVocabularyCommandInput): import("@smithy/core/client").CommandImpl<GetVocabularyCommandInput, GetVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVocabularyCommandInput): import("@smithy/core/client").CommandImpl<GetVocabularyCommandInput, GetVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
