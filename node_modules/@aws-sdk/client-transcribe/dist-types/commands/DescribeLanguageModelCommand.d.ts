...
declare const DescribeLanguageModelCommand_base: {
    new (input: DescribeLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<DescribeLanguageModelCommandInput, DescribeLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<DescribeLanguageModelCommandInput, DescribeLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
