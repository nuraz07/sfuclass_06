...
declare const ListMedicalVocabulariesCommand_base: {
    new (input: ListMedicalVocabulariesCommandInput): import("@smithy/core/client").CommandImpl<ListMedicalVocabulariesCommandInput, ListMedicalVocabulariesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMedicalVocabulariesCommandInput]): import("@smithy/core/client").CommandImpl<ListMedicalVocabulariesCommandInput, ListMedicalVocabulariesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
