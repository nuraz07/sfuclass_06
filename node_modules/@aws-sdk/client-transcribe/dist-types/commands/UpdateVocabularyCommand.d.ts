...
declare const UpdateVocabularyCommand_base: {
    new (input: UpdateVocabularyCommandInput): import("@smithy/core/client").CommandImpl<UpdateVocabularyCommandInput, UpdateVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateVocabularyCommandInput): import("@smithy/core/client").CommandImpl<UpdateVocabularyCommandInput, UpdateVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
