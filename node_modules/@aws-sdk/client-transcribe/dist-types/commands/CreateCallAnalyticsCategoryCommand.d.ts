...
declare const CreateCallAnalyticsCategoryCommand_base: {
    new (input: CreateCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCallAnalyticsCategoryCommandInput, CreateCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<CreateCallAnalyticsCategoryCommandInput, CreateCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
