...
declare const DeleteCallAnalyticsJobCommand_base: {
    new (input: DeleteCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCallAnalyticsJobCommandInput, DeleteCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCallAnalyticsJobCommandInput): import("@smithy/core/client").CommandImpl<DeleteCallAnalyticsJobCommandInput, DeleteCallAnalyticsJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
