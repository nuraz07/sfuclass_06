...
declare const CreateLanguageModelCommand_base: {
    new (input: CreateLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<CreateLanguageModelCommandInput, CreateLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<CreateLanguageModelCommandInput, CreateLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
