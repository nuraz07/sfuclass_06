...
declare const GetMedicalVocabularyCommand_base: {
    new (input: GetMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalVocabularyCommandInput, GetMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalVocabularyCommandInput, GetMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
