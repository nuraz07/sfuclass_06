...
declare const DeleteLanguageModelCommand_base: {
    new (input: DeleteLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteLanguageModelCommandInput, DeleteLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteLanguageModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteLanguageModelCommandInput, DeleteLanguageModelCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
