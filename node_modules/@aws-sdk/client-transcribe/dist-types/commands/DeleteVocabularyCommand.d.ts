...
declare const DeleteVocabularyCommand_base: {
    new (input: DeleteVocabularyCommandInput): import("@smithy/core/client").CommandImpl<DeleteVocabularyCommandInput, DeleteVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVocabularyCommandInput): import("@smithy/core/client").CommandImpl<DeleteVocabularyCommandInput, DeleteVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
