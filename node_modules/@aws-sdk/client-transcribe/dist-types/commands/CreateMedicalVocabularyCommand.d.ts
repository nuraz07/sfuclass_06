...
declare const CreateMedicalVocabularyCommand_base: {
    new (input: CreateMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<CreateMedicalVocabularyCommandInput, CreateMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateMedicalVocabularyCommandInput): import("@smithy/core/client").CommandImpl<CreateMedicalVocabularyCommandInput, CreateMedicalVocabularyCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
