...
declare const UpdateVocabularyFilterCommand_base: {
    new (input: UpdateVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<UpdateVocabularyFilterCommandInput, UpdateVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<UpdateVocabularyFilterCommandInput, UpdateVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
