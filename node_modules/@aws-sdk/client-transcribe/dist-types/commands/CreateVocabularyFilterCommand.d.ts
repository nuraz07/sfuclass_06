...
declare const CreateVocabularyFilterCommand_base: {
    new (input: CreateVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<CreateVocabularyFilterCommandInput, CreateVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<CreateVocabularyFilterCommandInput, CreateVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
