...
declare const ListCallAnalyticsCategoriesCommand_base: {
    new (input: ListCallAnalyticsCategoriesCommandInput): import("@smithy/core/client").CommandImpl<ListCallAnalyticsCategoriesCommandInput, ListCallAnalyticsCategoriesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCallAnalyticsCategoriesCommandInput]): import("@smithy/core/client").CommandImpl<ListCallAnalyticsCategoriesCommandInput, ListCallAnalyticsCategoriesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
