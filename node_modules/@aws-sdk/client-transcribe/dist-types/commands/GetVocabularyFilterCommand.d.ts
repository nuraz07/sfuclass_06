...
declare const GetVocabularyFilterCommand_base: {
    new (input: GetVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<GetVocabularyFilterCommandInput, GetVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<GetVocabularyFilterCommandInput, GetVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
