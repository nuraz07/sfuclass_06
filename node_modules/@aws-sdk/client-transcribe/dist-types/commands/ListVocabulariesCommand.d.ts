...
declare const ListVocabulariesCommand_base: {
    new (input: ListVocabulariesCommandInput): import("@smithy/core/client").CommandImpl<ListVocabulariesCommandInput, ListVocabulariesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVocabulariesCommandInput]): import("@smithy/core/client").CommandImpl<ListVocabulariesCommandInput, ListVocabulariesCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
