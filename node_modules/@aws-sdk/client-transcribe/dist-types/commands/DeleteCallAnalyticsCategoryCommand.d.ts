...
declare const DeleteCallAnalyticsCategoryCommand_base: {
    new (input: DeleteCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteCallAnalyticsCategoryCommandInput, DeleteCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCallAnalyticsCategoryCommandInput): import("@smithy/core/client").CommandImpl<DeleteCallAnalyticsCategoryCommandInput, DeleteCallAnalyticsCategoryCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
