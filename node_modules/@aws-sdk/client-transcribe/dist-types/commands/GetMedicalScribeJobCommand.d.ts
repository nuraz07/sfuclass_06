...
declare const GetMedicalScribeJobCommand_base: {
    new (input: GetMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalScribeJobCommandInput, GetMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<GetMedicalScribeJobCommandInput, GetMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
