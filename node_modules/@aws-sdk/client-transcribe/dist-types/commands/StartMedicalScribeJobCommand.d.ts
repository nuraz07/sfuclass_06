...
declare const StartMedicalScribeJobCommand_base: {
    new (input: StartMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<StartMedicalScribeJobCommandInput, StartMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMedicalScribeJobCommandInput): import("@smithy/core/client").CommandImpl<StartMedicalScribeJobCommandInput, StartMedicalScribeJobCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
