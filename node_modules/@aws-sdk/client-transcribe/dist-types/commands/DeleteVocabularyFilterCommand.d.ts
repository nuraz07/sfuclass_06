...
declare const DeleteVocabularyFilterCommand_base: {
    new (input: DeleteVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteVocabularyFilterCommandInput, DeleteVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVocabularyFilterCommandInput): import("@smithy/core/client").CommandImpl<DeleteVocabularyFilterCommandInput, DeleteVocabularyFilterCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
