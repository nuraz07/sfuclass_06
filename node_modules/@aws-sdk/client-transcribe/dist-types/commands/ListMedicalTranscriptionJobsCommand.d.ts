...
declare const ListMedicalTranscriptionJobsCommand_base: {
    new (input: ListMedicalTranscriptionJobsCommandInput): import("@smithy/core/client").CommandImpl<ListMedicalTranscriptionJobsCommandInput, ListMedicalTranscriptionJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMedicalTranscriptionJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListMedicalTranscriptionJobsCommandInput, ListMedicalTranscriptionJobsCommandOutput, import("..").TranscribeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
