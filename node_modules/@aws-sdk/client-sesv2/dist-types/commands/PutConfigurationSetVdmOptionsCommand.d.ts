...
declare const PutConfigurationSetVdmOptionsCommand_base: {
    new (input: PutConfigurationSetVdmOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetVdmOptionsCommandInput, PutConfigurationSetVdmOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutConfigurationSetVdmOptionsCommandInput): import("@smithy/core/client").CommandImpl<PutConfigurationSetVdmOptionsCommandInput, PutConfigurationSetVdmOptionsCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
