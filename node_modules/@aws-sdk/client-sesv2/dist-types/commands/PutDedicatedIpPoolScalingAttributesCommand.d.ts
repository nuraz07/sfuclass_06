...
declare const PutDedicatedIpPoolScalingAttributesCommand_base: {
    new (input: PutDedicatedIpPoolScalingAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutDedicatedIpPoolScalingAttributesCommandInput, PutDedicatedIpPoolScalingAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutDedicatedIpPoolScalingAttributesCommandInput): import("@smithy/core/client").CommandImpl<PutDedicatedIpPoolScalingAttributesCommandInput, PutDedicatedIpPoolScalingAttributesCommandOutput, import("..").SESv2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
