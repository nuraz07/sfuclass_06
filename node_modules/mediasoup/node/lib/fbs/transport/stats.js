...
class Stats {
    ...
    static addRtpRecvBitrate(builder, rtpRecvBitrate) {
        builder.addFieldInt64(8, rtpRecvBitrate, BigInt('0'));
    }
    ...
    static addRtpSendBitrate(builder, rtpSendBitrate) {
        builder.addFieldInt64(10, rtpSendBitrate, BigInt('0'));
    }
    ...
    static addRtxRecvBitrate(builder, rtxRecvBitrate) {
        builder.addFieldInt64(12, rtxRecvBitrate, BigInt('0'));
    }
    ...
    static addRtxSendBitrate(builder, rtxSendBitrate) {
        builder.addFieldInt64(14, rtxSendBitrate, BigInt('0'));
    }
    ...
    static addProbationSendBitrate(builder, probationSendBitrate) {
        builder.addFieldInt64(16, probationSendBitrate, BigInt('0'));
    }
    static addAvailableOutgoingBitrate(builder, availableOutgoingBitrate) {
        builder.addFieldInt64(17, availableOutgoingBitrate, null);
    }
    static addAvailableIncomingBitrate(builder, availableIncomingBitrate) {
        builder.addFieldInt64(18, availableIncomingBitrate, null);
    }
    static addMaxIncomingBitrate(builder, maxIncomingBitrate) {
        builder.addFieldInt64(19, maxIncomingBitrate, null);
    }
    static addMaxOutgoingBitrate(builder, maxOutgoingBitrate) {
        builder.addFieldInt64(20, maxOutgoingBitrate, null);
    }
    static addMinOutgoingBitrate(builder, minOutgoingBitrate) {
        builder.addFieldInt64(21, minOutgoingBitrate, null);
    }
...
class StatsT {
    ...
    rtpPacketLossReceived;
    rtpPacketLossSent;
    constructor(transportId = null, timestamp = BigInt('0'), sctpState = null, bytesReceived = BigInt('0'), recvBitrate = BigInt('0'), bytesSent = BigInt('0'), sendBitrate = BigInt('0'), rtpBytesReceived = BigInt('0'), rtpRecvBitrate = BigInt('0'), rtpBytesSent = BigInt('0'), rtpSendBitrate = BigInt('0'), rtxBytesReceived = BigInt('0'), rtxRecvBitrate = BigInt('0'), rtxBytesSent = BigInt('0'), rtxSendBitrate = BigInt('0'), probationBytesSent = BigInt('0'), probationSendBitrate = BigInt('0'), availableOutgoingBitrate = null, availableIncomingBitrate = null, maxIncomingBitrate = null, maxOutgoingBitrate = null, minOutgoingBitrate = null, rtpPacketLossReceived = null, rtpPacketLossSent = null) {
