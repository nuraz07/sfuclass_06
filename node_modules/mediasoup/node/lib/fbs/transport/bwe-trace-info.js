...
class BweTraceInfo {
    ...
    static addDesiredBitrate(builder, desiredBitrate) {
        builder.addFieldInt64(1, desiredBitrate, BigInt('0'));
    }
    static addEffectiveDesiredBitrate(builder, effectiveDesiredBitrate) {
        builder.addFieldInt64(2, effectiveDesiredBitrate, BigInt('0'));
    }
    static addMinBitrate(builder, minBitrate) {
        builder.addFieldInt64(3, minBitrate, BigInt('0'));
    }
    static addMaxBitrate(builder, maxBitrate) {
        builder.addFieldInt64(4, maxBitrate, BigInt('0'));
    }
    static addStartBitrate(builder, startBitrate) {
        builder.addFieldInt64(5, startBitrate, BigInt('0'));
    }
    static addMaxPaddingBitrate(builder, maxPaddingBitrate) {
        builder.addFieldInt64(6, maxPaddingBitrate, BigInt('0'));
    }
    static addAvailableBitrate(builder, availableBitrate) {
        builder.addFieldInt64(7, availableBitrate, BigInt('0'));
    }
...
class BweTraceInfoT {
    ...
    maxPaddingBitrate;
    availableBitrate;
    constructor(bweType = bwe_type_1.BweType.TRANSPORT_CC, desiredBitrate = BigInt('0'), effectiveDesiredBitrate = BigInt('0'), minBitrate = BigInt('0'), maxBitrate = BigInt('0'), startBitrate = BigInt('0'), maxPaddingBitrate = BigInt('0'), availableBitrate = BigInt('0')) {
