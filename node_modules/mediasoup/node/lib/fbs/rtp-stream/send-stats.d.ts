...
export declare class SendStats implements flatbuffers.IUnpackableObject<SendStatsT> {
    ...
    static createSendStats(builder: flatbuffers.Builder, baseOffset: flatbuffers.Offset, packetCount: bigint, byteCount: bigint, bitrate: bigint): flatbuffers.Offset;
    unpack(): SendStatsT;
...
export declare class SendStatsT implements flatbuffers.IGeneratedObject {
    ...
    byteCount: bigint;
    bitrate: bigint;
    constructor(base?: StatsT | null, packetCount?: bigint, byteCount?: bigint, bitrate?: bigint);
