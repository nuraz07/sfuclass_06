...
export declare class RecvStats implements flatbuffers.IUnpackableObject<RecvStatsT> {
    ...
    static addBitrate(builder: flatbuffers.Builder, bitrate: bigint): void;
    ...
    static createRecvStats(builder: flatbuffers.Builder, baseOffset: flatbuffers.Offset, packetCount: bigint, byteCount: bigint, bitrate: bigint, bitrateByLayerOffset: flatbuffers.Offset): flatbuffers.Offset;
    unpack(): RecvStatsT;
...
export declare class RecvStatsT implements flatbuffers.IGeneratedObject {
    ...
    constructor(base?: StatsT | null, packetCount?: bigint, byteCount?: bigint, bitrate?: bigint, bitrateByLayer?: (BitrateByLayerT)[]);
