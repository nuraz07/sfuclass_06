...
class EncodingMapping {
    ...
    static addMappedSsrc(builder, mappedSsrc) {
        builder.addFieldInt32(2, mappedSsrc, 0);
    }
    static endEncodingMapping(builder) {
        const offset = builder.endObject();
        return offset;
    }
    static createEncodingMapping(builder, ridOffset, ssrc, mappedSsrc) {
    ...
    unpack() {
        return new EncodingMappingT(this.rid(), this.ssrc(), this.mappedSsrc());
    }
    unpackTo(_o) {
        _o.rid = this.rid();
        _o.ssrc = this.ssrc();
...
class EncodingMappingT {
    ...
    ssrc;
    mappedSsrc;
    constructor(rid = null, ssrc = null, mappedSsrc = 0) {
        this.rid = rid;
        this.ssrc = ssrc;
    ...
    pack(builder) {
        ...
        return EncodingMapping.createEncodingMapping(builder, rid, this.ssrc, this.mappedSsrc);
    }
}
