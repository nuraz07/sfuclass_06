...
export declare class RtpEncodingParameters implements flatbuffers.IUnpackableObject<RtpEncodingParametersT> {
    ...
    static addMaxBitrate(builder: flatbuffers.Builder, maxBitrate: bigint): void;
...
export declare class RtpEncodingParametersT implements flatbuffers.IGeneratedObject {
    ssrc: number | null;
    ...
    maxBitrate: bigint | null;
    constructor(ssrc?: number | null, rid?: string | Uint8Array | null, codecPayloadType?: number | null, rtx?: RtxT | null, dtx?: boolean, scalabilityMode?: string | Uint8Array | null, maxBitrate?: bigint | null);
