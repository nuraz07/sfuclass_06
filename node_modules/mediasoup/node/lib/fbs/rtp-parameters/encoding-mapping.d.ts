...
export declare class EncodingMapping implements flatbuffers.IUnpackableObject<EncodingMappingT> {
    ...
    static createEncodingMapping(builder: flatbuffers.Builder, ridOffset: flatbuffers.Offset, ssrc: number | null, mappedSsrc: number): flatbuffers.Offset;
    unpack(): EncodingMappingT;
    unpackTo(_o: EncodingMappingT): void;
}
export declare class EncodingMappingT implements flatbuffers.IGeneratedObject {
    rid: string | Uint8Array | null;
    ssrc: number | null;
    mappedSsrc: number;
    constructor(rid?: string | Uint8Array | null, ssrc?: number | null, mappedSsrc?: number);
