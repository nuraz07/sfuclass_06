...
const fbsUtils = __importStar(require("./fbsUtils"));
const FbsActiveSpeakerObserver = __importStar(require("./fbs/active-speaker-observer"));
const FbsAudioLevelObserver = __importStar(require("./fbs/audio-level-observer"));
const FbsRequest = __importStar(require("./fbs/request"));
const FbsWorker = __importStar(require("./fbs/worker"));
const FbsRouter = __importStar(require("./fbs/router"));
const FbsTransport = __importStar(require("./fbs/transport"));
const protocol_1 = require("./fbs/transport/protocol");
const FbsWebRtcTransport = __importStar(require("./fbs/web-rtc-transport"));
const FbsPlainTransport = __importStar(require("./fbs/plain-transport"));
const FbsPipeTransport = __importStar(require("./fbs/pipe-transport"));
const FbsDirectTransport = __importStar(require("./fbs/direct-transport"));
const logger = new Logger_1.Logger('Router');
class RouterImpl extends enhancedEvents_1.EnhancedEventEmitter {
    // Internal data.
    #internal;
    // Router data.
    #data;
    ...
    async createWebRtcTransport({ webRtcServer, listenInfos, listenIps, port, enableUdp, enableTcp, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, sctpDefaultStreamBufferedAmountLowThreshold = 1024, iceConsentTimeout = 30, appData, }) {
        ...
        /* direct */ undefined, BigInt(initialAvailableOutgoingBitrate), enableSctp, maxSendMessageSize, maxReceiveMessageSize, sctpSendBufferSize, sctpPerStreamSendQueueLimit, sctpMaxReceiverWindowBufferSize, sctpDefaultStreamBufferedAmountLowThreshold, 
        /* isDataChannel */ true);
        ...
        const transport = new WebRtcTransport_1.WebRtcTransportImpl({
            internal: {
                ...this.#internal,
    ...
    async createPlainTransport({ listenInfo, rtcpListenInfo, listenIp, port, rtcpMux = true, comedia = false, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, sctpDefaultStreamBufferedAmountLowThreshold = 1024, enableSrtp = false, srtpCryptoSuite = 'AES_CM_128_HMAC_SHA1_80', appData, }) {
        ...
        const baseTransportOptions = new FbsTransport.OptionsT(
        /* direct */ undefined, 
        /* initialAvailableOutgoingBitrate */ undefined, enableSctp, maxSendMessageSize, maxReceiveMessageSize, sctpSendBufferSize, sctpPerStreamSendQueueLimit, sctpMaxReceiverWindowBufferSize, sctpDefaultStreamBufferedAmountLowThreshold, 
        /* isDataChannel */ false);
        ...
        const transport = new PlainTransport_1.PlainTransportImpl({
            internal: {
                ...this.#internal,
                transportId: transportId,
            },
    ...
    async createPipeTransport({ listenInfo, listenIp, port, enableSctp = false, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, sctpDefaultStreamBufferedAmountLowThreshold = 1024, enableRtx = false, enableSrtp = false, appData, }) {
        ...
        const pipeTransportOptions = new FbsPipeTransport.PipeTransportOptionsT(baseTransportOptions, new FbsTransport.ListenInfoT(listenInfo.protocol === 'udp'
            ? protocol_1.Protocol.UDP
            : protocol_1.Protocol.TCP, listenInfo.ip, listenInfo.announcedAddress ?? listenInfo.announcedIp, Boolean(listenInfo.exposeInternalIp), listenInfo.port, (0, Transport_1.portRangeToFbs)(listenInfo.portRange), (0, Transport_1.socketFlagsToFbs)(listenInfo.flags), listenInfo.sendBufferSize, listenInfo.recvBufferSize), enableRtx, enableSrtp);
    ...
    async createDirectTransport({ maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, appData, } = {}) {
        ...
        /* enableSctp */ undefined, maxSendMessageSize, maxReceiveMessageSize, 
        ...
        const transport = new DirectTransport_1.DirectTransportImpl({
            internal: {
                ...this.#internal,
                transportId: transportId,
            },
    ...
    async pipeToRouter({ producerId, dataProducerId, router, keepId = true, listenInfo, listenIp, enableSctp = true, maxSendMessageSize = 262144, maxReceiveMessageSize = 262144, sctpSendBufferSize = 2000000, sctpPerStreamSendQueueLimit = 2000000, sctpMaxReceiverWindowBufferSize = 5242880, sctpDefaultStreamBufferedAmountLowThreshold = 1024, enableRtx = false, enableSrtp = false, }) {
        ...
        if (producerId) {
            ...
            if (!producer) {
                throw new errors_1.NotFoundError('Producer not found');
            }
        }
        else if (dataProducerId) {
            dataProducer = this.#dataProducers.get(dataProducerId);
            if (!dataProducer) {
                throw new errors_1.NotFoundError('DataProducer not found');
            }
        }
        ...
        if (pipeTransportPairPromise) {
            ...
            pipeTransportPairPromise = new Promise((resolve, reject) => {
                Promise.all([
                    ...
                    .catch(error => {
                    logger.error('pipeToRouter() | error creating PipeTransport pair:', error);
        ...
        if (producer) {
            ...
            try {
                ...
                if (producer.closed) {
                    throw new errors_1.NotFoundError('original Producer closed');
                }
                ...
                logger.error('pipeToRouter() | error creating pipe Consumer/Producer pair:', error);
                if (pipeConsumer) {
                    pipeConsumer.close();
                }
                if (pipeProducer) {
            ...
            try {
                ...
                if (dataProducer.closed) {
                    throw new errors_1.NotFoundError('original DataProducer closed');
                }
                ...
                logger.error('pipeToRouter() | error creating pipe DataConsumer/DataProducer pair:', error);
    ...
    async createActiveSpeakerObserver({ interval = 300, appData, } = {}) {
        ...
        const activeSpeakerObserver = new ActiveSpeakerObserver_1.ActiveSpeakerObserverImpl({
            internal: {
                ...this.#internal,
    ...
    async createAudioLevelObserver({ maxEntries = 1, threshold = -80, interval = 1000, appData, } = {}) {
        ...
        const audioLevelObserver = new AudioLevelObserver_1.AudioLevelObserverImpl({
            internal: {
                ...this.#internal,
                rtpObserverId: rtpObserverId,
            },
...
function parseRouterDumpResponse(binary) {
    return {
        ...
        mapProducerIdConsumerIds: fbsUtils.parseStringStringArrayVector(binary, 'mapProducerIdConsumerIds'),
        mapConsumerIdProducerId: fbsUtils.parseStringStringVector(binary, 'mapConsumerIdProducerId'),
        mapProducerIdObserverIds: fbsUtils.parseStringStringArrayVector(binary, 'mapProducerIdObserverIds'),
        mapDataProducerIdDataConsumerIds: fbsUtils.parseStringStringArrayVector(binary, 'mapDataProducerIdDataConsumerIds'),
        mapDataConsumerIdDataProducerId: fbsUtils.parseStringStringVector(binary, 'mapDataConsumerIdDataProducerId'),
    };
}
