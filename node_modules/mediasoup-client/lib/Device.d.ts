...
import type { HandlerFactory, HandlerForcedRtpExtensions } from './handlers/HandlerInterface';
...
export declare class Device {
     ...
     */
    static factory({ handlerName, handlerFactory, forcedRtpExtensions, }?: DeviceOptions): Promise<Device>;
    /**
     * Create a new Device to connect to mediasoup server.
     *
     * @throws {UnsupportedError} if device is not supported.
     */
    constructor({ handlerName, handlerFactory, forcedRtpExtensions, }?: DeviceOptions);
    /**
