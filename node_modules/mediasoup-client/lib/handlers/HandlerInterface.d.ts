...
import type { RtpCapabilities, RtpCodecCapability, RtpParameters, RtpEncodingParameters, RtpHeaderExtensionUri, ExtendedRtpCapabilities } from '../RtpParameters';
...
export type HandlerFactory = {
    ...
    getNativeRtpCapabilities(options: HandlerGetNativeRtpCapabilitiesOptions): Promise<RtpCapabilities>;
};
export type HandlerOptions = {
    ...
    getSendExtendedRtpCapabilities: (nativeSendRtpCapabilities: RtpCapabilities) => ExtendedRtpCapabilities;
    forcedRtpExtensions?: HandlerForcedRtpExtensions;
};
