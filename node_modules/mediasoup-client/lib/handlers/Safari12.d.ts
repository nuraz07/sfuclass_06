...
export declare class Safari12 extends EnhancedEventEmitter<HandlerEvents> implements HandlerInterface {
     ...
     */
    static createFactory({ forcedRtpExtensions, }: HandlerFactoryOptions): HandlerFactory;
    private static getLocalRtpCapabilities;
    constructor({ direction, iceParameters, iceCandidates, dtlsParameters, sctpParameters, iceServers, iceTransportPolicy, additionalSettings, getSendExtendedRtpCapabilities, forcedRtpExtensions, }: HandlerOptions);
    get name(): string;
    close(): void;
    ...
    send({ track, streamId, encodings, codecOptions, codec, onRtpSender, }: HandlerSendOptions): Promise<HandlerSendResult>;
    ...
    sendDataChannel({ sctpStreamParameters, }: HandlerSendDataChannelOptions): Promise<HandlerSendDataChannelResult>;
    ...
    receiveDataChannel({ maxMessageSize, sctpStreamParameters, label, protocol, }: HandlerReceiveDataChannelOptions): Promise<HandlerReceiveDataChannelResult>;
