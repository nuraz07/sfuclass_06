...
test('removeOngoingTasksWithSameName option removes ongoing tasks with same name', async () => {
    ...
    for (let i = 0; i < 10; ++i) {
        awaitQueue
            ...
            .catch(error => {
            if (error instanceof __1.AwaitQueueRemovedTaskError) {
                ++removedTaskACount;
            }
        });
    }
